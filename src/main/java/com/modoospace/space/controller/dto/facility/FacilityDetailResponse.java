...
public class FacilityDetailResponse {
    ...
    @Builder
    public FacilityDetailResponse(Long id, String name, Boolean reservationEnable, Integer minUser,
    ...
    public static List<FacilityDetailResponse> of(List<Facility> facilities) {
        return facilities.stream()
                .map(FacilityDetailResponse::of)
