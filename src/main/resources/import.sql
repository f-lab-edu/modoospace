...
insert into reservation (reservation_id, created_time, updated_time, facility_id, reservation_start, reservation_end, status, visitor_id) values (default, now(), now(), 2, '2023-07-02T10:00:00', '2023-07-02T12:59:59','COMPLETED', 3);
